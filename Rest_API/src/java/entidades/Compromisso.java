...
public class Compromisso implements Serializable {
    ...
    public Compromisso(Date data, Time hora, Time duracao) {
        this.data = data;
        this.hora = hora;
        this.duracao = duracao;
    }

    public Compromisso(Date data, Time hora, Time duracao, List<Participante> participante, Localizacao local) {
        this.data = data;
        this.hora = hora;
        this.duracao = duracao;
